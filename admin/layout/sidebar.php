              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="master-kriteria.php" class="menu-link">
                    <div data-i18n="Without navbar">Data Kriteria</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="master-bobot.php" class="menu-link">
                    <div data-i18n="Without navbar">Data Pembobotan</div>
                  </a>
                </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="proses-registrasi-pasien.php" class="menu-link">
                    <div data-i18n="Without menu">Registrasi Pasien</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="proses-deteksi.php" class="menu-link">
                    <div data-i18n="Without navbar">Proses Deteksi</div>
                  </a>
                </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="laporan-hasil-deteksi.php" class="menu-link">
                    <div data-i18n="Without menu">Laporan Deteksi Pasien</div>
                  </a>
                </li>
