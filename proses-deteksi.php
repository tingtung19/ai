                      ...
                      <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                          ...
                          <select class="form-control" id="basic-icon-default-fullname" placeholder="Nama Lengkap" aria-label="Nama Lengkap" aria-describedby="basic-icon-default-fullname2">
                            <option value="Laki-laki">Nama Pasien A</option>
                            <option value="Laki-laki">Nama Pasien B</option>
                            <option value="Laki-laki">Nama Pasien C</option>
                            <option value="Laki-laki">Nama Pasien D</option>
                          </select>
                        </div>
                      </div>
                    </div>
